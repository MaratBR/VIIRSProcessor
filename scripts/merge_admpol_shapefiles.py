...
def main():
    ...
    merge_shapefiles(glob(os.path.join(location, 'Kemerovo/*_admpol.shp'), recursive=True), '/tmp/adm/kem_adpol.shp')
    merge_shapefiles(glob(os.path.join(location, 'Omsk/*_admpol.shp'), recursive=True), '/tmp/adm/omsk_adpol.shp')
